#############################################################################
# Makefile for building: computer_calculator.app/Contents/MacOS/computer_calculator
# Generated by qmake (3.1) (Qt 6.10.1)
# Project:  computer_calculator.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile computer_calculator.pro
#############################################################################
...
CXXFLAGS      = -pipe -stdlib=libc++ -std=c++17 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=14.0 -Wall -Wextra $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = computer_calculator1.0.0
DISTDIR = /Users/pank-su/Documents/labs4sem/oop2_lab_2/.tmp/computer_calculator1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		computer_calculator.pro src/mainwindow.h src/qt_main.cpp \
		src/mainwindow.cpp
QMAKE_TARGET  = computer_calculator
DESTDIR       = 
TARGET        = computer_calculator.app/Contents/MacOS/computer_calculator

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 26.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/pank-su/Documents/labs4sem/oop2_lab_2/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/pank-su/Documents/labs4sem/oop2_lab_2/computer_calculator.pro
...
computer_calculator.app/Contents/MacOS/computer_calculator: ui_mainwindow.h $(OBJECTS)  
	@test -d computer_calculator.app/Contents/MacOS/ || mkdir -p computer_calculator.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: computer_calculator.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile computer_calculator.pro
...
computer_calculator.app/Contents/PkgInfo: 
	@test -d computer_calculator.app/Contents || mkdir -p computer_calculator.app/Contents
	@$(DEL_FILE) computer_calculator.app/Contents/PkgInfo
	@echo "APPL????" > computer_calculator.app/Contents/PkgInfo
computer_calculator.app/Contents/Info.plist: 
	@test -d computer_calculator.app/Contents || mkdir -p computer_calculator.app/Contents
	@$(DEL_FILE) computer_calculator.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,su.pank.computer-calculator,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},su.pank.computer-calculator,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,computer_calculator,g" -e "s,@LIBRARY@,computer_calculator,g" -e "s,\$${EXECUTABLE_NAME},computer_calculator,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >computer_calculator.app/Contents/Info.plist

all: Makefile \
		computer_calculator.app/Contents/PkgInfo \
		computer_calculator.app/Contents/Info.plist computer_calculator.app/Contents/MacOS/computer_calculator
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/qt_main.cpp src/mainwindow.cpp $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r computer_calculator.app
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -std=c++17 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=14.0 -Wall -Wextra -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
...
moc_mainwindow.cpp: src/mainwindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/pank-su/Documents/labs4sem/oop2_lab_2/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/pank-su/Documents/labs4sem/oop2_lab_2 -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib src/mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: src/mainwindow.ui \
	...
	/opt/homebrew/share/qt/libexec/uic src/mainwindow.ui -o ui_mainwindow.h
...
qt_main.o: src/qt_main.cpp src/mainwindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMainWindow \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qmainwindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QApplication \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qapplication.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qt_main.o src/qt_main.cpp
